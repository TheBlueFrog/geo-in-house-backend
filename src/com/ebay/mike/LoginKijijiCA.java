...
public class LoginKijijiCA
{
	 ...
	 * 
	 * args
	 * [0, 1] = "OpCode", "LoginKijijiCA"
	 * [2, 3] = name, value
	 */
	
	static String mEndpoint				= "http://mingle.kijiji.ca/api/users/login";
	
	static String mUserName         	= "";
	static String mPassword				= "";
	
	private static String mOtherUserName = "ca_iphone_app_5";
	private static String mOtherPassword = "4Z%SBiydAFwp";
